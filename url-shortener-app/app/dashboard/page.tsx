            ...
            <form onSubmit={handleCreateUrl} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <Label htmlFor="original_url" className="text-base font-semibold text-gray-700">
                    Original URL *
                  </Label>
                  <Input
                    id="original_url"
                  ...
                  />
                  <p className="text-sm text-gray-500">Enter the URL you want to shorten and track</p>
                </div>
                <div className="space-y-3">
                  <Label htmlFor="custom_url" className="text-base font-semibold text-gray-700">
                    Custom Name 
